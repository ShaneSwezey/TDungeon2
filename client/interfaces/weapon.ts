import { KnifeName, OneHandedAxeName, OneHandedSwordName, StaffName, TwoHandedAxeName, TwoHandedSwordName, WeaponType } from "../enums/weapon";
...
export interface IWeapon {
    ...
    //readonly effects: Effect[]; // Add later.
    readonly crit: ICrit;
